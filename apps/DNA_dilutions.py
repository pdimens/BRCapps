...
def _(copy, df, pd, start_ul, target_ng):
    ...
    # Only style cells in the H2O column where value < 0
    ...
    def recalc_dilution(updated_df):
        # updated_df is the full edited table
...
def _(file_import, io, mo, pd):
    ...
    mo.stop(
        ...
        but those columns were not found. Instead, the input file has columns:
